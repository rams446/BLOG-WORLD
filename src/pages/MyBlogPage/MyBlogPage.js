    ...
    export default function MyBlogPage() {
        ...
        return (
            <div>
            <form className={styles.li}><button onClick={showForms} name="button">CREATE BLOG</button></form>
            ...
            <div></div>
            <button className={styles.il1} name="post"  >Post</button> 
        
            </form>
            <h3>My blogs</h3>
            { <h4 className={styles.blogs}>{showblog?.map((blogs) => {
